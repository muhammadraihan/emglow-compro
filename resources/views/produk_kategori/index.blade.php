...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Product Categories </span>
        <small>
            Module for manage Product Categories.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>
                    Product Categories  <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('produk_kategori.create')}}"><i class="fal fa-plus-circle">
                        </i>
...
<script>
    $(document).ready(function(){
       ...
       var table = $('#datatable').DataTable({
            ...
            "order": [[ 0, "asc" ]],
            "ajax":{
                url:'{{route('produk_kategori.index')}}',
                type : "GET",
                dataType: 'json',
                error: function(data){
                    console.log(data);
