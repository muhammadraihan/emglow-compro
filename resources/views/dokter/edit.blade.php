...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>Dokter</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    @endif
                    {!! Form::open(['route' => ['dokter.update',$dokter->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-3 mb-3">
                        {{ Form::label('cabang','Cabang',['class' => 'required form-label'])}}
                        {!! Form::select('cabang', $cabang, $dokter->uuid_cabang, ['id' =>
                        'cabang','class' =>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('name',$dokter->name,['placeholder' => 'Nama Dokter','class' => 'form-control '.($errors->has('name') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::textarea('deskripsi',$dokter->deskripsi,['placeholder' => 'Deskripsi Dokter','class' => 'form-control '.($errors->has('deskripsi') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-15 mb-6">
                        ...
                        {{ Form::textarea('jadwal',$dokter->jadwal,['placeholder' => 'Jadwal Dokter','class' => 'form-control '.($errors->has('jadwal') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        <input type="hidden" name="oldImage" value="{{ $dokter->photo }}"> 
                        @if ($dokter->photo)
                            <img src="{{ asset('photo/' . $dokter->photo) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
