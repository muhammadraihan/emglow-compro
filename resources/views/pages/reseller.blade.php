        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-4 col-lg-12">
                        <div class="img-reseller" align="centre">
                            <img src="/img/join-reseller.jpg" alt="">
                        </div>
                        <div class="mt-3 desc-box" align="center">
                            <table>
                                <thead>
                                    <tr>
                                        <th class="h3" style="padding-right: 20px;">Nama Wilayah</th>
                                        <th class="h3" style="padding-right: 20px;">No. Telephone</th>
                                ...
                                @foreach ($reseller as $item)
                                    <tr>
                                        <td class="desc">{{ $item->wilayah_reseller }}</td>
                                        <td class="desc"><a href="{{ 'https://wa.me/'.$item->telephone }}" class="btn btn-outline-emglow">Whatsapp</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                            {{-- <div class="h3">Nama Wilayah</div>
                            <div class="h3">No. Telephone</div>
                            <p class="desc">{!! $item->wilayah_reseller !!}</p>
                            <p class="desc">{!! $item->telephone !!}</p> --}}
                            ...
                            {{-- <a href="{{ 'https://wa.me/'.$item->telephone }}">{{ $item->telephone }}</div></a> --}}
                            {{-- <a href="{{ 'https://wa.me/'.$item->telephone }}" class="btn btn-outline-emglow">WA MINTIK</a> --}}
