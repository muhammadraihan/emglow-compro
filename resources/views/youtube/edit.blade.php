...
@section('title', 'Link Youtube Edit')
        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('detail','Deskripsi',['class' => 'required form-label'])}}
                        {{ Form::textarea('detail',$youtube->detail,['placeholder' => 'Deskripsi','class' => 'form-control '.($errors->has('detail') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
