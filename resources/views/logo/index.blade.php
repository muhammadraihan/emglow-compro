...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Logo </span>
        <small>
            Module for manage Logo.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>
                    Logo  <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    @if ($data_logo == 0)
                    <a class="nav-link active" href="{{route('logo.create')}}"><i class="fal fa-plus-circle">
                        </i>
