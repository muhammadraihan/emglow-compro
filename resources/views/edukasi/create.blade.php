...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Edukasi </i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    @endif
                    {!! Form::open(['route' => 'edukasi.store','id'=>'forms','method' => 'POST','class' =>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('name',null,['placeholder' => 'Nama Edukasi','class' => 'form-control '.($errors->has('name') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::textarea('deskripsi',null,['placeholder' => 'Deskripsi Edukasi','class' => 'form-control '.($errors->has('deskripsi') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::textarea('link',null,['placeholder' => 'link Edukasi','class' => 'form-control '.($errors->has('link') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('link'))
