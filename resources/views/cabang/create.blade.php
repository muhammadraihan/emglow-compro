            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-15 mb-6">
                        ...
                        {{ Form::textarea('alamat',null,['placeholder' => 'Alamat Cabang','class' => 'form-control '.($errors->has('alamat') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-15 mb-6">
                        ...
                        {{ Form::textarea('detail',null,['placeholder' => 'Detail Cabang','class' => 'form-control '.($errors->has('detail') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
