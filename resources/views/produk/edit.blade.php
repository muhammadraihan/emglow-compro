...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>Produk</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('name',$produk->name,['placeholder' => 'Nama Produk','class' => 'form-control '.($errors->has('name') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::textarea('deskripsi',$produk->deskripsi,['placeholder' => 'Deskripsi Produk','class' => 'form-control '.($errors->has('deskripsi') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        @if ($produk->photo)
                            <img src="{{ asset('photo/' . $produk->photo) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
